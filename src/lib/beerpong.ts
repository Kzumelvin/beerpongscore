...
export function getScoreBoard(
  ...
  spiele
    .filter((f) => f.game_type == "Gruppenphase")
    .forEach((g) => {
  ...
  st.sort(
    (a, b) =>
      b.avePoints - a.avePoints ||
      b.diffCups - a.diffCups ||
      b.posCups - a.posCups ||
      a.negCups - b.negCups,
  );
...
export function matchPerGroup(
    ...
    allGames = [
      {
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[0], away_team: group[1] },
      },
      {
        home_team: group[0].id!,
        away_team: group[2].id!,
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[0], away_team: group[2] },
      },
      {
        home_team: group[0].id!,
        away_team: group[3].id!,
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[0], away_team: group[3] },
      },
      {
        home_team: group[0].id!,
        away_team: group[4].id!,
        game_type: "Gruppenphase",
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[0], away_team: group[4] },
      },
      {
        home_team: group[1].id!,
        away_team: group[2].id!,
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[1], away_team: group[2] },
      },
      {
        home_team: group[1].id!,
        away_team: group[3].id!,
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[1], away_team: group[3] },
      },
      {
        home_team: group[1].id!,
        away_team: group[4].id!,
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[1], away_team: group[4] },
      },
      {
        home_team: group[2].id!,
        away_team: group[3].id!,
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[2], away_team: group[3] },
      },
      {
        home_team: group[2].id!,
        away_team: group[4].id!,
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[2], away_team: group[4] },
      },
      {
        home_team: group[3].id!,
        away_team: group[4].id!,
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[3], away_team: group[4] },
      },
    ];
  }
  ...
  if (group.length == 6) {
    allGames = [
      ...
      {
        home_team: group[0].id!,
        away_team: group[5].id!,
        game_type: "Gruppenphase",
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[0], away_team: group[5] },
      },
      {
        home_team: group[1].id!,
        away_team: group[2].id!,
      ...
      },
      {
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[1], away_team: group[5] },
      },
      {
        home_team: group[2].id!,
        away_team: group[3].id!,
      ...
      },
      {
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[2], away_team: group[5] },
      },
      {
        home_team: group[3].id!,
        away_team: group[4].id!,
      ...
      },
      {
        ...
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[3], away_team: group[5] },
      },
      {
        home_team: group[4].id!,
        away_team: group[5].id!,
        game_type: "Gruppenphase",
        groupStage: letter,
        game_number: 0,
        expand: { home_team: group[4], away_team: group[5] },
      },
    ];
  }
  return allGames;
...
export function matchmakingGroup(
  tournamentID: string,
  groupA: teamType[],
  groupB?: teamType[],
  groupC?: teamType[],
  ...
  if (groupB?.length && groupB.length > 2) {
    b = matchPerGroup(groupB, "B");
    countTeams = b.length > countTeams ? b.length : countTeams;
  }

  if (groupC?.length && groupC.length > 2) {
    c = matchPerGroup(groupC, "C");
    countTeams = c.length > countTeams ? c.length : countTeams;
  }
  if (groupD?.length && groupD.length > 2) {
    d = matchPerGroup(groupD, "D");
    countTeams = d.length > countTeams ? d.length : countTeams;
  }
  if (groupE?.length && groupE.length > 2) {
    e = matchPerGroup(groupE, "E");
    countTeams = e.length > countTeams ? e.length : countTeams;
  }

  for (let i = 0; i < countTeams; i++) {
    if (a.length > 0) {
      a[0].game_number = gamesCount;
      a[0].tournament = tournamentID;
      gamesCount += 1;
      allMatches.push(a[0]);
      a.splice(0, 1);
    }
    if (b.length > 0) {
      b[0].game_number = gamesCount;
      b[0].tournament = tournamentID;
      gamesCount += 1;
      allMatches.push(b[0]);
      b.splice(0, 1);
    }
    if (c.length > 0) {
      c[0].game_number = gamesCount;
      c[0].tournament = tournamentID;
      gamesCount += 1;
      allMatches.push(c[0]);
      c.splice(0, 1);
    }
    if (d.length > 0) {
      d[0].game_number = gamesCount;
      d[0].tournament = tournamentID;
      gamesCount += 1;
      allMatches.push(d[0]);
      d.splice(1, 0);
    }
    if (e.length > 0) {
      e[0].game_number = gamesCount;
      e[0].tournament = tournamentID;
      gamesCount += 1;
      allMatches.push(e[0]);
      e.splice(1, 0);
    }
...
export function matchmakingKO(
  tournamentID: string,
  groupScoreBoard: scoreBoard,
  gespielteSpiele: gameType[],
) {
  let allMatches: gameType[] = [];
  let finalScoreBoard: finaleScoreBoard = [];
  let gamesCount: number =
    gespielteSpiele.filter(
      (f) => f.tournament == tournamentID && f.game_type == "Gruppenphase",
    ).length + 1;
  let koSpiele: gameType[] = gespielteSpiele.filter(
    (f) => f.game_type != "Gruppenphase",
  );
  ...
  if (scoreBoard.length == 6 || 7 || 9 || 10 || 11 || 12) {
    ...
    //
    koSpiele
      .filter((f) => f.game_type == "Relegation")
      .forEach((kg) => {
        console.log("Begegnung Relegation");
        console.log(
          kg.expand.home_team.team_name,
          " vs. ",
          kg.expand.away_team.team_name,
        );

        const index = relGames.findIndex(
          (f) => f.home_team == kg.home_team && f.away_team == kg.away_team,
        );
        ...
        if (kg.home_cups! > kg.away_cups!) {
          let scoreIndex = scoreBoard.findIndex(
            (f) => f.team.id == kg.away_team,
          );
          ...
          finalScoreBoard.push({
            ...
            groupIndex:
              groupScoreBoard.findIndex((f) => f.team.id == kg.away_team) + 1,
            finalIndex: 0,
          });
        ...
        if (kg.home_cups! < kg.away_cups!) {
          ...
          finalScoreBoard.push({
            ...
            diffCups: scoreBoard[scoreIndex].diffCups,
            groupIndex:
              groupScoreBoard.findIndex((f) => f.team.id == kg.home_team) + 1,
            finalIndex: 0,
          });
    ...
    finalScoreBoard.sort(
      (a, b) => b.finalIndex - a.finalIndex || a.groupIndex - b.groupIndex,
    );
  ...
  if (scoreBoard.length == 8) {
    ...
    //
    koSpiele
      .filter((f) => f.game_type == "Viertelfinale")
      .forEach((kg) => {
        console.log("KO:", kg);

        const index = viertelGames.findIndex(
          (f) => f.home_team == kg.home_team && f.away_team == kg.away_team,
        );
        console.log("Index", index);
  ...
  if (scoreBoard.length == 4) {
    ...
    //
    koSpiele
      .filter((f) => f.game_type == "Halbfinale")
      .forEach((kg) => {
        console.log("Begegnung Relegation");
        console.log(
          kg.expand.home_team.team_name,
        ...
        const index = halbGames.findIndex(
          (f) => f.home_team == kg.home_team && f.away_team == kg.away_team,
        );
  ...
  if (ThreeScoreBoard.length == 2) {
    ...
    for (let i = 0; i < gamesNumber; i++) {
      ...
      threeGames.push({
        home_team:
          ThreeScoreBoard.at(-gamesNumber * 2 + i)?.team.id! || "not found",
        ...
        expand: {
          home_team:
            ThreeScoreBoard.at(-gamesNumber * 2 + i)?.team || "not found",
    ...
    //
    koSpiele
      .filter((f) => f.game_type == "Spiel um Platz 3")
      .forEach((kg) => {
        console.log("KO:", kg);

        const index = threeGames.findIndex(
          (f) => f.home_team == kg.home_team && f.away_team == kg.away_team,
        );
        console.log("Index", index);
        ...
        // Übertrag von GruppenTabelel in Endtabelle
        if (kg.home_cups! > kg.away_cups!) {
          let scoreIndex = ThreeScoreBoard.findIndex(
            (f) => f.team.id == kg.away_team,
          );
          ...
          let scoreIndexWin = ThreeScoreBoard.findIndex(
            (f) => f.team.id == kg.home_team,
          );
          finalScoreBoard.push({
  ...
  if (scoreBoard.length == 2 && ThreeScoreBoard.length == 0) {
    ...
    //
    koSpiele
      .filter((f) => f.game_type == "Finale")
      .forEach((kg) => {
        console.log("KO:", kg);

        const index = finalGames.findIndex(
          (f) => f.home_team == kg.home_team && f.away_team == kg.away_team,
        );
        console.log("Index", index);
        ...
        if (kg.home_cups! > kg.away_cups!) {
          ...
          let scoreIndexWin = scoreBoard.findIndex(
            (f) => f.team.id == kg.home_team,
          );
          finalScoreBoard.push({
